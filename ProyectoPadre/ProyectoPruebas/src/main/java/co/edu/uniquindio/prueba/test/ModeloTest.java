...
//	public void probarListaProductosUsuario() {
//
//		TypedQuery<Object[]> q = entityManager.createNamedQuery(User.PRODUCTOS_USUARIO, Object[].class);
//
//		for (Object[] arreglo : q.getResultList()) {
//
